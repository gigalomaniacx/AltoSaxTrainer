const model = {
   ...
   notes: [
      ...
      {
         name: 'Ash',
         noteImg: './src/Ash-Note.png',
         size: '140',
      },
      {
         name: 'B',
         noteImg:'./src/B-Note.png',
         size:'140',
      },
      {
         name: 'Bb',
         noteImg:'./src/Bb-Note.png',
         size:'140',
      },
      {
         name: 'Bsh',
         noteImg:'./src/Bsh-Note.png',
         size:'140',
      },
      {
         name: 'C',
         noteImg:'./src/C-Note.png',
         size:'140',
      },
      {
         name: 'Cb',
         noteImg:'./src/Cb-Note.png',
         size:'140',
      },
      {
         name: 'Csh',
         noteImg: './src/Csh-Note.png',
         size: '140'
      },
      {
         name: 'Db',
         noteImg: './src/Db-Note.png',
         size: '140'
      },
      {
         name: 'HighA',
         noteImg: './src/HighA-Note.png',
         size: '140'
      },
      {
         name: 'HighAb',
         noteImg: './src/HighAb-Note.png',
         size: '140'
      },
      {
         name: 'HighB',
         noteImg: './src/HighB-Note.png',
         size: '140'
      },
      {
         name: 'HighBsh',
         noteImg: './src/HighBsh-Note.png',
         size: '140'
      },
      {
         name: 'HighC',
         noteImg: './src/HighC-Note.png',
         size: '140'
      },
      {
         name: 'HighCb',
         noteImg: './src/HighCb-Note.png',
         size: '140'
      },
      {
         name: 'HighCsh',
         noteImg: './src/HighCsh-Note.png',
         size: '140'
      },
      {
         name: 'HighD',
         noteImg: './src/HighD-Note.png',
         size: '140'
      },
      {
         name: 'HighDb',
         noteImg: './src/HighDb-Note.png',
         size: '140'
      },
      {
         name: 'HighDsh',
         noteImg: './src/HighDsh-Note.png',
         size: '140'
      },
      {
         name: 'HighE',
         noteImg: './src/HighE-Note.png',
         size: '140'
      },
      {
         name: 'HighEb',
         noteImg: './src/HighEb-Note.png',
         size: '140'
      },
      {
         name: 'HigherD',
         noteImg: './src/HigherD-Note.png',
         size: '140'
      },
      {
         name: 'HigherDsh',
         noteImg: './src/HigherDsh-Note.png',
         size: '140'
      },
      {
         name: 'HigherE',
         noteImg: './src/HigherE-Note.png',
         size: '140'
      },
      {
         name: 'HigherEb',
         noteImg: './src/HigherEb-Note.png',
         size: '140'
      },
      {
         name: 'HigherEsh',
         noteImg: './src/HigherEsh-Note.png',
         size: '140'
      },
      {
         name: 'HigherF',
         noteImg: './src/HigherF-Note.png',
         size: '140'
      },
      {
         name: 'HigherFb',
         noteImg: './src/HigherFb-Note.png',
         size: '140'
      }
   ],
